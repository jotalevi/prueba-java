...
public class Interfaz extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton2ActionPerformed
        ...
        model.addRow(new String[] { libro.getCodigo().toString(), libro.getDescripcion().toString(),
                "" + libro.getPrecio(), "" + libro.getCantidad(),
                "" + libro.calcularSubTotal(this.controladorVentanaPrincipal.getVenta().getLibros()) });
